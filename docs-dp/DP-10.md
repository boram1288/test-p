...
- 신뢰/비신뢰 주체: Host의 중앙 orchestrator는 비신뢰 관리 주체다. Camera/AI pVM과 DP-03/DP-04의 보호 집행 주체는 기존 신뢰 경계를 유지한다.
...
[DP-03 보호 buffer] as Buf
Cam -down-> Buf : 프레임 (데이터 흐름, 실선)
Buf -down-> AI : 프레임 (데이터 흐름, 실선)
AI -down-> Orc : 비민감 결과 (데이터 흐름, 실선)
