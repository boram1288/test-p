...
- project-custom 범위는 pVM과 기존 공용 TrustZone TEE 사이 제어/data envelope 전달 경로다.
...
- 자원 소유/회수: TEE가 pVM별 session을 소유한다. pVM/relay 장애 때 TEE session manager가 session을 만료/회수한다.
