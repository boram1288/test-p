...
package "복구·자원·계약" #F3E8FD {
    rectangle "DP-07\n장애 복구 범위" as DP07 #F3E8FD
    rectangle "DP-08\nCPU 공유 경계" as DP08 #F3E8FD
    rectangle "DP-09\nAPI 호환 책임" as DP09 #F3E8FD
    rectangle "DP-10\n실행·역압 책임" as DP10 #F3E8FD
}
...
DP09 --> DP02 : 계약 안정화 후 검증 인터페이스
DP09 --> DP03 : 계약 안정화 후 채널 인터페이스
DP09 --> DP04 : 계약 안정화 후 HW 요청 인터페이스
