...
| DP-05 | 보안 워크로드·Secure OS 탑재 방식 결정 | T-연계 | FR-06, FR-07, QA-07, QA-08, CONST-06 | 순서 5 |
| DP-06 | TrustZone 연동 구조 배치 | T-연계 | FR-08, CONST-03 | 순서 4 전 선행 |
...
| DP-12 | 보안 정책·권한 집행 모델 | 교차 | QA-01, QA-02, FR-03, FR-04, FR-06, CONST-02 | 순서 1 병행 |
...
```mermaid
flowchart TD
    DP01["DP-01<br/>신뢰 모델 확정<br/>(순서 1)"]
    DP11["DP-11<br/>침해 시도 탐지·변조 불가 로깅<br/>(순서 1 병행)"]
    DP07["DP-07<br/>격리 증빙·감사 체계<br/>(순서 1 병행)"]
    DP12["DP-12<br/>보안 정책·권한 집행 모델<br/>(순서 1 병행)"]
    DP02["DP-02<br/>생명주기·다중 pVM 관리 골격 설계<br/>(순서 2)"]
    DP03["DP-03<br/>HW IP SW 중재 구조 설계<br/>(순서 3 병행 가능)"]
    DP06["DP-06<br/>TrustZone 연동 구조 배치<br/>(순서 4 전 선행)"]
    DP04["DP-04<br/>zero-copy 보안 채널 구조 설계<br/>(순서 4)"]
    DP10["DP-10<br/>pVM 아이덴티티·채널 상대 인증<br/>(순서 4 병행)"]
    DP08["DP-08<br/>보호 자산 저장(at-rest) 보호<br/>(순서 5 전)"]
    DP09["DP-09<br/>pVM 부팅 무결성 검증<br/>(순서 5 병행)"]
    DP05["DP-05<br/>보안 워크로드·Secure OS 탑재 방식 결정<br/>(순서 5)"]
