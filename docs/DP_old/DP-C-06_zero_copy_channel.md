...
**산출근거 Driver (05 DP-C-06)**: FR-04, QA-01/QA-02(채널 격리/기밀성), QA-02, QA-03, QA-04(버퍼 자원 효율)
...
- **단점**: 암복호화 비용이 프레임마다 발생해 zero-copy의 목적(QS-05) 자체를 부정한다. 대용량 영상에서 실시간성(QA-02) 미달이 거의 확실하다. 단독 후보가 아니라 비교 기준선이다.
...
| E3. 파이프라인 실시간성 | 1080p30 지속 유입에서 E2E 지연 목표 기여 (QA-02, steady-state hypercall 빈도) |
