...
|-------|-------------|:--------:|-------------|--------------------|
| QA-01 | 보안 — 침해 기밀성 (QS-01) | 1순위 | VOS-01, VOS-15 | Host 침해 상황에서도 데이터 비노출을 보장하고 개인정보·규제 대응을 위한 기술적 격리 증빙을 제공한다. |
...
| CS-02 | GP 표준 규격 준수 | VOS-12 | 기존 TrustZone TEE 기능과 SMC 경로의 호환성을 유지하기 위해 GlobalPlatform 표준 인터페이스를 준수한다. |
