...
**선정 결과: QA-01, QA-02, QA-03, QA-04, QA-05, QA-06, QA-07, QA-08, QA-11 (9건)**
...
선정된 driver는 총 **22건** (FR 7 + QA 9 + CONST 6)이다.

| 구분 | 선정 Driver | 제외 |
|------|------------|------|
| 기능 (FR) | FR-01, FR-02, FR-03, FR-04, FR-06, FR-07, FR-08 | FR-05, FR-09 |
| 품질 (QA) | QA-01, QA-02, QA-03, QA-04, QA-05, QA-06, QA-07, QA-08, QA-11 | QA-09, QA-10 |
...
| 5 | 보안 워크로드·Secure OS 탑재 방식 결정 | FR-06, FR-07, QA-07, QA-08, CONST-06 | T-4 |
...
| 4. Architectural Driver 선정 | `04_architectural_drivers.md` (본 문서) | Driver 22건 = 중요 FR 7 + 핵심 QA 9 + CONST 전체 6 |
