...
| Workload Loader / Verifier | 서명 검증 후 보안 Workload 동적 탑재 | FR-05, QA-04, CONST-06 |
| HW IP Mediation Layer | Camera/AI HW를 Host와 pVM이 공유하도록 SW 중재 | FR-03, QA-02, CONST-05 |
...
| Secure OS Adapter | pVM 내 Workload의 ENC/DEC 요청을 Secure OS로 전달 | FR-06, QA-09, CONST-03 |
