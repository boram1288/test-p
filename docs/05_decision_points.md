...
|:-------:|:------------:|-----------|-------------------------------------|
| **DP1** | DP-C-03 | 기밀성, 확장성, 가용성을 위한 pVM 관리 골격 설계 | FR-01, FR-02, QA-01, QA-04, QA-07, CS-01 |
| **DP2** | DP-C-04 | 무결성 보장을 위한 보안 Workload 실행 방식 설계 | FR-06, QA-01, QA-04, QA-05 |
| **DP3** | DP-C-06 | 성능(통신 오버헤드)을 위한 zero-copy 보안 채널 구조 설계 | FR-04, QA-01, QA-02, QA-03, QA-04 |
| **DP4** | DP-C-07 | 성능(실시간 처리) 및 자원 효율을 위한 HW IP 중재 구조 설계 | FR-03, QA-04, QA-09, CS-05 |
| **DP5** | DP-C-05 | GP API Backward Compatibility를 위한 TrustZone 연동 구조 설계 | FR-08, QA-03, CS-03 |
| **DP6** | DP-C-08 | 보안(기밀성)을 위한 Secure Storage 구조 설계 | FR-08, QA-01, QA-04 |
