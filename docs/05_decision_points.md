...
| DP-C-05 | GP API Backward Compatibility를 위한 TrustZone 연동 구조 설계 | FR-08, QA-03, CS-03 | DP-C-01 | DP3 |
| DP-C-06 | 성능(통신 오버헤드)을 위한 zero-copy 보안 채널 구조 설계 | FR-04, QA-01, QA-02, QA-03, QA-04 | DP-C-04 | DP4 |
| DP-C-07 | 성능(실시간 처리) 및 자원 효율을 위한 HW IP 중재 구조 설계 | FR-03, QA-04, QA-09, CS-05 | DP-C-04 | DP5 |
...
| 단계 | 요청/동작 | DP-C-03<br/>pVM 관리 골격 | DP-C-04<br/>Workload 실행 방식 | DP-C-05<br/>TrustZone 연동 | DP-C-06<br/>zero-copy 보안 채널 | DP-C-07<br/>HW IP 중재 | DP-C-08<br/>Secure Storage |
|---:|---|:---:|:---:|:---:|:---:|:---:|:---:|
