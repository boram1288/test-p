...
| DP-C-03 | 기밀성, 확장성, 가용성을 위한 pVM 관리 골격 설계 | FR-01, FR-02, FR-05, QA-01, QA-04, QA-06, CS-01, CS-02 | DP-C-02 | DP1 |
| DP-C-04 | 무결성 보장을 위한 보안 Workload 실행 방식 설계 | FR-01, FR-05, QA-01, QA-04, CS-01, CS-02 | DP-C-03 | DP2 |
| DP-C-05 | GP API Backward Compatibility를 위한 TrustZone 연동 구조 설계 | FR-06, QA-01, QA-03, QA-05, CS-03 | DP-C-01, DP-C-07 | DP5 |
| DP-C-06 | 성능(통신 오버헤드)을 위한 zero-copy 보안 채널 구조 설계 | FR-03, FR-04, QA-01, QA-02, QA-03, QA-05, CS-01, CS-02 | DP-C-04 | DP3 |
| DP-C-07 | 성능(실시간 처리) 및 자원 효율을 위한 HW IP 중재 구조 설계 | FR-03, QA-01, QA-02, QA-03, CS-01, CS-02 | DP-C-06 | DP4 |
| DP-C-08 | 보안(기밀성)을 위한 Secure Storage 구조 설계 | FR-06, QA-01, QA-03, CS-03 | DP-C-05, DP-C-04 | DP6 |
...
DPC03["DP-C-03<br/>기밀성, 확장성, 가용성을 위한<br/>pVM 관리 골격 설계<br/>(→ DP1)"]
DPC04["DP-C-04<br/>무결성 보장을 위한<br/>보안 Workload 실행 방식 설계<br/>(→ DP2)"]
DPC05["DP-C-05<br/>GP API Backward Compatibility를 위한<br/>TrustZone 연동 구조 설계<br/>(→ DP5)"]
DPC06["DP-C-06<br/>성능(통신 오버헤드)을 위한<br/>zero-copy 보안 채널 구조 설계<br/>(→ DP3)"]
DPC07["DP-C-07<br/>성능(실시간 처리) 및 자원 효율을 위한<br/>HW IP 중재 구조 설계<br/>(→ DP4)"]
...
| DP 선정 | DP Candidate | DP 제목 | 관련 Driver |
|:-------:|:------------:|-----------|-------------------------------------|
| **DP1** | DP-C-03 | 기밀성, 확장성, 가용성을 위한 pVM 관리 골격 설계 | FR-01, FR-02, FR-05, QA-01, QA-04, QA-06, CS-01, CS-02 |
| **DP2** | DP-C-04 | 무결성 보장을 위한 보안 Workload 실행 방식 설계 | FR-01, FR-05, QA-01, QA-04, CS-01, CS-02 |
| **DP3** | DP-C-06 | 성능(통신 오버헤드)을 위한 zero-copy 보안 채널 구조 설계 | FR-03, FR-04, QA-01, QA-02, QA-03, QA-05, CS-01, CS-02 |
| **DP4** | DP-C-07 | 성능(실시간 처리) 및 자원 효율을 위한 HW IP 중재 구조 설계 | FR-03, QA-01, QA-02, QA-03, CS-01, CS-02 |
| **DP5** | DP-C-05 | GP API Backward Compatibility를 위한 TrustZone 연동 구조 설계 | FR-06, QA-01, QA-03, QA-05, CS-03 |
| **DP6** | DP-C-08 | 보안(기밀성)을 위한 Secure Storage 구조 설계 | FR-06, QA-01, QA-03, CS-03 |
| **DP7** | DP-C-01 | 시스템의 보안 정책 신뢰를 위한 신뢰 모델 결정 | QA-01, CS-02 |
| **DP8** | DP-C-02 | 접근 통제 일관성을 위한 보안 정책 및 권한 집행 모델 설계 | QA-01, FR-01, FR-02, FR-03, FR-04, FR-06, CS-02 |
