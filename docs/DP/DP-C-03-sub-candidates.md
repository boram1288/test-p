...
| 권한 Context 전달 | DP-C-02의 Host app 권한과 Workload 권한을 pVM 생성 시 어떻게 묶는가? | app 권한만 사용 / Workload label 별도 전달 / 둘 다 검증 |
...
DP-C-03에서는 pVM 생성 요청 안에 Workload의 SELinux 권한 Context를
